					...
					<div className="grid grid-cols-1 items-start gap-8 md:grid-cols-2 md:gap-12">
						...
						<div className="space-y-6">
							...
							<div className="space-y-4 font-mono text-muted-foreground text-sm leading-relaxed md:text-base">
								<p>
									Bedankt voor je deelname aan de LLM fundamentals workshop.
									Tijdens de training hebben we gekeken naar de werking en het
								...
								<p>
									Je kunt de Agent ook vragen naar de slides, mocht je nog eens
									wat na willen lezen.
								</p>

								<p>
									Je kunt dit interview op elk moment onderbreken en later
									hervatten met dezelfde code, maar ik zou het fijn vinden als
									je de feedback die je wilt geven geeft binnen ongeveer 2
									weken.
								</p>

								<p>
									Als laatste: mocht je nu of in de toekomst nog bepaalde AI
									gerelateerde vragen of uitdagingen hebben, denk ik heel graag
									met je mee. Stuur me gerust een Teams berichtje of email in
									dat geval.
								</p>
