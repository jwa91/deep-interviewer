...
function renderFieldValue(value: unknown): React.ReactNode {
  ...
  if (typeof value === "number") {
    ...
    return <span className="font-bold font-mono text-foreground text-sm">{value}</span>;
  }

  // Strings and other types
  return <p className="font-mono text-foreground text-sm leading-relaxed">{String(value)}</p>;
}
