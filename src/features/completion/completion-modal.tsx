...
export function CompletionModal({ isOpen, onClose, workshopSlidesUrl }: CompletionModalProps) {
  return (
            ...
            <div className="grid grid-cols-1 items-start gap-8 md:grid-cols-2 md:gap-12">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 font-mono text-muted-foreground text-sm leading-relaxed md:text-base">
                  <p>
                    Super bedankt voor het meedoen aan dit AI interview, ik ga aan de slag met de
                    feedback.
                  </p>

                  {workshopSlidesUrl && (
                    <div className="pt-2">
                      <p className="mb-2">Hier is nogmaals de link naar de slides:</p>
                      <a
                  ...
                  <div className="pt-2">
                    <p className="mb-2">
                      Mocht je benieuwd zijn hoe deze applicatie gemaakt is, check Github hier:
                    </p>
                    <a
